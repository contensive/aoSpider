...
Public Class SpiderClass
    ...
    Public Overrides Function Execute(ByVal CP As CPBaseClass) As Object
        ...
        Try
            ...
            Dim linkCopies As List(Of LinkAliasModel) = New List(Of LinkAliasModel)
            ...
            For Each link In links
                If (Not String.IsNullOrEmpty(link.name)) Then
                    Dim linkAlias As LinkAliasModel = New LinkAliasModel
                    Dim querystring As String = link.querystringsuffix
                    linkAlias.querystringsuffix = link.querystringsuffix
                    linkAlias.pageid = link.pageid



                    If (Not linkCopies.Contains(linkAlias)) Then

                            linkCopies.Add(linkAlias)
